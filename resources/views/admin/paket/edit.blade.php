    ...
    <form method="POST" action="{{ route('admin.paket.update', $paketWisata) }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="lokasi" id="lokasi" value="{{ old('lokasi', $paketWisata->lokasi) }}" required placeholder="Contoh: Bali, Lombok, Raja Ampat"
            ...
            <div>
                ...
                <input type="text" name="durasi" id="durasi" value="{{ old('durasi', $paketWisata->durasi) }}" required placeholder="Contoh: 3 Hari 2 Malam"
            ...
            <div>
                ...
                <input type="url" name="gambar_url" id="gambar_url" value="{{ old('gambar_url', $paketWisata->gambar_url) }}" placeholder="https://example.com/gambar.jpg"
        ...
        <div class="mt-6">
            ...
            <textarea name="deskripsi" id="deskripsi" rows="5" required
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi', $paketWisata->deskripsi) }}</textarea>
            @error('deskripsi')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
        ...
        @if($paketWisata->gambar_url)
            <div class="mt-6">
                ...
                <img src="{{ $paketWisata->gambar_url }}" alt="{{ $paketWisata->nama_paket }}" class="w-48 h-32 object-cover rounded-lg">
            </div>
        @endif
